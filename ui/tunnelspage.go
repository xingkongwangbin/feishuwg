...
func NewTunnelsPage() (*TunnelsPage, error) {
	...
	tp.fillerButton.SetMinMaxSize(walk.Size{Width: 200, Height: 0}, walk.Size{Width: 200, Height: 0})
...
func (tp *TunnelsPage) CreateToolbar() error {
	...
	importAction.SetShortcut(walk.Shortcut{Modifiers: walk.ModControl, Key: walk.KeyO})
	...
	addAction.SetShortcut(walk.Shortcut{Modifiers: walk.ModControl, Key: walk.KeyN})
	...
	fixContainerWidthToToolbarWidth := func() {
		...
		tp.listContainer.SetMinMaxSizePixels(walk.Size{Width: toolbarWidth, Height: 0}, walk.Size{Width: toolbarWidth, Height: 0})
	}
	...
	importAction2.SetShortcut(walk.Shortcut{Modifiers: walk.ModControl, Key: walk.KeyO})
	...
	addAction2.SetShortcut(walk.Shortcut{Modifiers: walk.ModControl, Key: walk.KeyN})
	...
	deleteAction2.SetShortcut(walk.Shortcut{Modifiers: 0, Key: walk.KeyDelete})
