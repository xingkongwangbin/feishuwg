...
:installdeps
	rem rmdir /s /q .deps 2> NUL
	rem mkdir .deps || goto :error
	cd .deps || goto :error
	rem call :download go.zip https://go.dev/dl/go1.18.windows-amd64.zip 65c5c0c709a7ca1b357091b10b795b439d8b50e579d3893edab4c7e9b384f435 || goto :error
